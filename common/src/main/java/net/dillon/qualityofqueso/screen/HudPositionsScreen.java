...
public class HudPositionsScreen extends Screen {
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float deltaTicks) {
        ...
        graphics.blit(getArmorHotbarTexture(), this.armorStatusXPosition.getX() + 60, this.armorStatusXPosition.getY() - 28, 0.0F, 0.0F, 82, 22, 82, 22);
        graphics.pose().popPose();
        RenderSystem.disableBlend();

        graphics.blit(ofQoQ("textures/gui/sprites/hud/item_counter.png"), this.armorStatusXPosition.getX() + 74, this.itemCounterXPosition.getY() - 32, 0.0F, 0.0F, 58, 30, 58, 30);
    }
}