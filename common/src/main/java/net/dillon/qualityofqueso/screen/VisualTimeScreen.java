...
public class VisualTimeScreen extends Screen {
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float deltaTicks) {
        ...
        graphics.blit(RenderPipelines.GUI_TEXTURED, Identifier.withDefaultNamespace("textures/block/daylight_detector" + (clientOptionsInstance().getVisualTimeOptions().syncLocalTime ? "_inverted" : "") + "_top.png"), this.matchWithIRLTime.getX() - 48, this.matchWithIRLTime.getY() - 2, 0.0F, 0.0F, SIZE, SIZE, SIZE, SIZE);
