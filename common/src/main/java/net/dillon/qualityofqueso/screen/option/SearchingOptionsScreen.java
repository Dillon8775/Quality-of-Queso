...
public class SearchingOptionsScreen extends AbstractModOptionsScreen {
    ...
    protected void activateButtons() {
        ...
        boolean searchBarTransparent = searchingEnabled && ModHelper.options().accessibility.widgetTheme.searchBarTransparent();
        this.searchBarPosition.active = searchingEnabled;
        this.searchBarColor.active = searchingEnabled;
        this.searchBarTextColorField.active = searchBarTransparent;
        this.underlineText.active = searchBarTransparent;
    }
