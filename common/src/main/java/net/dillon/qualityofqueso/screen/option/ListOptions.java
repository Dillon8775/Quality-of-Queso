...
import static net.dillon.qualityofqueso.keybind.ModKeyMappings.getDropKey;
...
public class ListOptions {
    ...
    protected static OptionInstance<Boolean> scrollMoving() {
        return createClientBooleanOption("scroll_moving", true, options().management.scrollMoving,
                (options, value) -> options.management.scrollMoving = value, kumaKeyMappingAsString(ModKeyMappings.SCROLL_MOVE, false)
        );
    }
    ...
    protected static OptionInstance<Boolean> itemFrameSearching() {
        return createCommonBooleanOption("item_frame_searching", true, coptions().itemFrameSearching,
                ...
                kumaKeyMappingAsString(ModKeyMappings.OPEN_SEARCH_ITEM_FRAMES_GUI, false));
    }
    ...
    protected static OptionInstance<Boolean> quickEquip() {
        return createClientBooleanOption("quick_equip", true, options().misc.quickEquip,
                ...
                kumaKeyMappingAsString(ModKeyMappings.QUICK_EQUIP, false)
        );
    }
    ...
    protected static OptionInstance<Boolean> autoCloseRecipeBook() {
        return createClientBooleanOption("auto_close_recipe_book", true, options().misc.autoCloseRecipeBook,
    ...
    public static OptionInstance<Integer> itemFrameSearchRadius() {
        return new OptionInstance<>("qualityofqueso.options.item_frame_search_radius",
                ...
                (optionText, value) -> Options.genericValueLabel(optionText, Component.literal(value + " blocks")),
                new OptionInstance.IntRange(10, 256).xmap(value -> value * 2, value -> value / 2, true), options().misc.itemFrameSearchRadius, value -> options().misc.itemFrameSearchRadius = value);
    }
    ...
    protected static OptionInstance<SearchBarColor> searchBarColor() {
        return createEnumOption(
                ...
                option -> switch (option) {
                    ...
                    case VANILLA -> Tooltip.create(Component.translatable("qualityofqueso.options.search_bar_color.vanilla.tooltip"));
