...
public class ListOptionUtil {
     ...
     */
    protected static <T> OptionInstance<Boolean> createSimpleBooleanOption(
            String translation,
            boolean toggleText,
     ...
     */
    protected static OptionInstance<Boolean> createCommonBooleanOption(String translation, boolean toggleText, boolean currentValue, BiConsumer<ModCommonOptions, Boolean> consumer, Object... obj) {
        return createSimpleBooleanOption(
                translation,
                toggleText,
                currentValue,
     ...
     */
    protected static OptionInstance<Boolean> createUniversalBooleanOption(String translation, boolean toggleText, boolean currentValue, BiConsumer<UniversalOptions, Boolean> consumer, Object... obj) {
        return createSimpleBooleanOption(
                translation,
                toggleText,
                currentValue,
    ...
    /**
     * @return an enum {@link OptionInstance}.
     */
    protected static <T, E extends Enum<E> & OptionEnum> OptionInstance<@NotNull E> createEnumOption(
            String translation,
            OptionInstance.TooltipSupplier<@NonNull E> tooltipFactory,
            E[] values, Codec<E> codec,
            E currentValue, BaseOptions<T> instance,
            BiConsumer<T, E> consumer) {
        return new OptionInstance<>(
                "qualityofqueso.options." + translation,
                tooltipFactory,
                (optionText, value) -> value.getTranslationKey(),
    ...
    /**
     * @return a client-instance enum {@link OptionInstance}.
     */
    protected static <E extends Enum<E> & OptionEnum> OptionInstance<@NotNull E> createEnumOption(
            String translation,
            OptionInstance.TooltipSupplier<@NonNull E> tooltipFactory,
            E[] values, Codec<E> codec,
            E currentValue, BiConsumer<ModClientOptions, E> consumer) {
