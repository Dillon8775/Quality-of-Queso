...
public abstract class AbstractModOptionsScreen extends OptionsSubScreen {
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float deltaTicks) {
        ...
        if (buttonActive(this.screenshotsButton)) {
            ...
            if (ModHelper.options().accessibility.tooltips.on() && this.screenshotsButton.isHovered()) {
        ...
        if (buttonActive(this.worldDirectoryButton)) {
            ...
            if (ModHelper.options().accessibility.tooltips.on() && this.worldDirectoryButton.isHovered()) {
        ...
        if (this.viewEnderChestButton != null) {
            ...
            if (ModHelper.options().accessibility.tooltips.on() && this.viewEnderChestButton.isHovered()) {
