...
public class AccessibilityOptionsScreen extends AbstractModOptionsScreen {
    private AbstractWidget searchInventory, darkDisc, darkOverlay, elytraAlarmSoundDelay, ignoreFabricTags;
    ...
    protected AbstractWidget[] options() {
        ...
        this.darkDisc = createOption(ListOptions.darkDisc());
    ...
    protected void activateButtons() {
        ...
        this.darkDisc.active = false;
        this.ignoreFabricTags.active = Balm.getPlatform().equals("fabric");
    }

    @Override
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float deltaTicks) {
        super.render(graphics, mouseX, mouseY, deltaTicks);
        if (this.blacklistedServersField.isMouseOver(mouseX, mouseY)) {
