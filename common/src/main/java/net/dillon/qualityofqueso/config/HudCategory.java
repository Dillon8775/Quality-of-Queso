    ...
    protected static ConfigCategory create() {
        Option<Boolean> armorHotbar = Option.<Boolean>createBuilder()
                ...
                .description(value -> {
                    ...
                    ResourceLocation location = value ? ofQoQ("options/hud/armor_hotbar") : ofQoQ("options/hud/no_armor_hotbar");
        ...
        Option<Boolean> highlightArmor = Option.<Boolean>createBuilder()
                ...
                .description(value -> {
                    ...
                    ResourceLocation location = value ? ofQoQ("options/hud/highlight_armor") : ofQoQ("options/hud/armor_hotbar");
                    return builder.customImage(fixedSizeImage(location, 82, 21)).build();
                })
        ...
        Option<Boolean> emptySlots = Option.<Boolean>createBuilder()
                ...
                .description(value -> {
                    ...
                    ResourceLocation location = value ? ofQoQ("options/hud/empty_slots") : ofQoQ("options/hud/no_empty_slots");
                    return builder.customImage(fixedSizeImage(location, 82, 21)).build();
                })
