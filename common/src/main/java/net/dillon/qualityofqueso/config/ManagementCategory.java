...
import static net.dillon.qualityofqueso.helper.ModKeybindHelper.getUsersDropKey;
import static net.dillon.qualityofqueso.util.ModOptionUtil.keyMappingAsString;
                                        ...
                                        Option.<Transferring>createBuilder()
                                                ...
                                                .description(OptionDescription.of(
                                                        Component.translatable("qualityofqueso.options.transferring.description",
                                                                "CTRL + " + keyMappingAsString(ModKeybinds.MOVE_TO_CONTAINER, false),
                                                                "CTRL + " + keyMappingAsString(ModKeybinds.MOVE_TO_INVENTORY, false)
                                                        )))
                                        ...
                                        Option.<QuickDrop>createBuilder()
                                                ...
                                                .description(OptionDescription.of(
                                                        Component.translatable("qualityofqueso.options.quick_drop.description",
                                                                "CTRL + ALT + " + keyMappingAsString(getUsersDropKey(), false)
                                                        )))
                                        ...
                                        Option.<Sorting>createBuilder()
                                                ...
                                                .description(OptionDescription.of(
                                                        Component.translatable("qualityofqueso.options.sorting.description",
                                                                "CTRL + " + keyMappingAsString(ModKeybinds.SORT, false)
                                                        )))
                                        ...
                                        Option.<Boolean>createBuilder()
                                                ...
                                                .description(OptionDescription.of(
                                                        Component.translatable("qualityofqueso.options.lock_slots.description",
                                                                "ALT + " + keyMappingAsString(ModKeybinds.LOCK_SLOT, true)
                                                        )))
                                        ...
                                        Option.<Swapping>createBuilder()
                                                ...
                                                .description(OptionDescription.of(
                                                        Component.translatable("qualityofqueso.options.swapping.description",
                                                                "CTRL + " + keyMappingAsString(ModKeybinds.SWAP_ITEMS, false)
                                                        )))
