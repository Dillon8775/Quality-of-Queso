                                ...
                                .option(
                                        Option.<SearchBarPosition>createBuilder()
                                                ...
                                                .description(value -> {
                                                    ...
                                                    return switch (value) {
                                                        case OVERLAY -> builder.customImage(fixedSizeImage(ofQoQ("textures/gui/sprites/options/searching/overlay.png"), 160, 90)).build();
                                                        case TOP -> builder.customImage(fixedSizeImage(ofQoQ("textures/gui/sprites/options/searching/top.png"), 160, 90)).build();
                                                    };
                                                })
                                ...
                                .option(
                                        Option.<SearchBarColor>createBuilder()
                                                ...
                                                .description(value -> {
                                                    ...
                                                    return switch (value) {
                                                        case BLACK -> builder.customImage(fixedSizeImage(ofQoQ("textures/gui/sprites/options/searching/black.png"), 117, 111)).build();
                                                    };
                                                })
                                                .binding(SearchBarColor.BLACK, () -> clientOptionsInstance().getSearchingOptions().searchBarColor, v -> clientOptionsInstance().getSearchingOptions().searchBarColor = v)
                                                .controller(o -> EnumControllerBuilder.create(o)
