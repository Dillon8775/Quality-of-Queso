...
public class SearchingCategory {
    ...
    protected static ConfigCategory create() {
        Option<Color> searchBarTextColorOption = Option.<Color>createBuilder()
                ...
                .available(clientOptionsInstance().getSearchingOptions().searchBarColor.transparent())
                .build();
                                ...
                                .option(
                                        Option.<SearchBarColor>createBuilder()
                                                ...
                                                .description(value -> {
                                                    ...
                                                    return switch (value) {
                                                        case DEFAULT -> builder.customImage(fixedSizeImage(ofQoQ("options/searching/default"), 117, 111)).build();
                                                        case VANILLA -> builder.customImage(fixedSizeImage(ofQoQ("options/searching/vanilla"), 117, 111)).build();
