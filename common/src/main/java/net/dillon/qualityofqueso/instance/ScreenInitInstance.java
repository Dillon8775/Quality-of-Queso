...
public class ScreenInitInstance extends ManagementInstance {
    ...
    public void readdExcludedSlots() {
        if (isValidScreen(instance().getScreen()) && options().management.saveExcludedSlots && instance().getCachedContainer() != null) {
            ...
            if (instance().getScreen() instanceof InventoryScreen recipeScreen && getRecipeBookComponent(recipeScreen).isVisible()) {
                return;
            }
    ...
    public void initializeContainer() {
        ...
        if (instance().getScreen() instanceof BrewingStandScreen brewingStandScreen) {
            ...
            instance().setCachedContainer(abstractFurnaceScreen.getMenu().getSlot(abstractFurnaceScreen.getMenu().getResultSlotIndex()).container);
