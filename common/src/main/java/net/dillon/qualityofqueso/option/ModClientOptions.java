...
public class ModClientOptions {
    ...
    private final DebugHuds debugHuds = new DebugHuds();
    ...
    public DebugHuds getDebugHuds() {
        return this.debugHuds;
    }
    ...
    public static class DebugHuds {
        public boolean showInGameTime = false;
        public boolean showRealLifeTime = false;
