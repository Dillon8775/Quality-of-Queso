...
public abstract class ToggleableButton extends QuesoButton {
    ...
    protected void renderWidget(GuiGraphics context, int mouseX, int mouseY, float deltaTicks) {
        this.activateButton();
        this.renderBaseButtonTexture(this.option() ? this.onTextureId() : this.offTextureId(), this, context, mouseX, mouseY);
        if (this.isMouseOver(mouseX, mouseY) && clientOptionsInstance().getGeneralOptions().tooltips.enabled()) {
