    ...
    protected void renderWidget(GuiGraphics graphics, int mouseX, int mouseY, float deltaTicks) {
        ...
        if (screen != null) {
            if (isBrewingStandScreen(screen)) {
                ...
                ButtonUtil.drawTooltip(Component.translatable("qualityofqueso.gui." + this.buttonName + "_button.furnace", abstractFurnaceScreen.getMenu().getSlot(abstractFurnaceScreen.getMenu().getResultSlotIndex()).getItem().getHoverName()), graphics, this.font, mouseX, mouseY);
                return;
            }
        }
