...
<div align="center">
    <h2>Features include:</h2>
        <ul>
          <li>An easy-to-use <a href="https://quality-of-queso.fandom.com/wiki/Search_Bar">search bar</a> for your inventory and chests</li>
          <li>Precise <a href="https://quality-of-queso.fandom.com/wiki/Category:Inventory_Management">Inventory Management</a>, building upon other inventory management mods</li>
          <li><a href="https://quality-of-queso.fandom.com/wiki/Container_Filtering">Container Filtering </a>and <a href="https://quality-of-queso.fandom.com/wiki/Container_Sorting">Sorting</a></li>
          <li>Locked slots</li>
          <li><a href="https://quality-of-queso.fandom.com/wiki/Item_Count">Item Counter</a> and <a href="https://quality-of-queso.fandom.com/wiki/Armor_Status">Armor Status</a></li>
          <li><a href="https://quality-of-queso.fandom.com/wiki/Remove_Fog">Remove fog</a></li>
          <li>And more!</li>
        </ul>
</div>
...
<details>
    <summary>
        ...
        <ul>
            <li><b>Search</b> for items in a <b>container</b> or <b>your inventory</b></li>
            <br>
            <li><b>Search multiple items</b> at once by separating each query with a <i><b>,</b></i></li>
            ...
            <br>
            <li>Fully configurable with different modes and appearances in the mod's <code>Searching</code> tab</li>
        <br>
        <p>
...
<details>
    <summary>
        ...
        <ul>
            ...
            <li><b>Quickly drop items</b> (CTRL + ALT + Q)</li>
            <li>And more!</li>
            <br>
            <li>Fully configurable in the mod's <code>Management</code> tab
        </ul>
        <p>
...
<details>
    <summary>
        ...
        <ul>
            <li><b>Display the total count of an item</b> you are holding (in stacks or just exact amount, configurable)</li>
            <li><b>Counts contents</b> inside <b>transportable containers</b></li>
            <li><b>Shows arrow count</b> when using a bow</li>            
            <li>Shows when <b>throwing/picking up</b> an item</li>
            <br>
            <li>Configurable in the mod's <code>Item Counter</code> tab</li>
        </ul>
        <p>
...
<details>
    <summary>
        ...
        <ul>
            <li><b>Display your armor's status</b> in-game</li>
            <li>Option to always display or only when updated</li>
            <li>Highlights with a color, depending on <b>armor durability</b> (configurable)</li>
            <br>
            <li>Configurable in the mod's <code>HUD</code> tab</li>
        </ul>
        <p>
...
<details>
    <summary>
        ...
        <ul>
            <li>Set what can change your FOV</li>
            <li>Toggle sprinting, potion effects, flying, bow pulling, and submerged in fluid to change FOV</li>
            <br>
            <li>Configurable in the mod's <code>FOV Effects</code> tab</li>
        </ul>
        <p>
...
<details>
    <summary>
        ...
        <ul>
            <li>Plays the "player hit" sound when hitting a mob from at least 15 blocks away</li>
            <li>Plays the "level up" sound when killing a mob</li>
            <br>
            <li>Configurable in the mod's <code>Miscellaneous</code> tab</li>
        </ul>
        <p>
...
<details>
    <summary>
        ...
        <ul>
            <li>Plays an alarm when you fall far enough without an elytra equipped</li>
            <br>
            <li>Configurable in the mod's <code>Miscellaneous</code> tab</li>
        </ul>
        <p>
...
<details>
    <summary>
        ...
        <ul>
            ...
            <li>Set <b>nether fog intensity</b> and <b>overworld fog intensity</b></li>
            <br>
            <li>Configurable in the mod's <code>Fog</code> tab</li>
        </ul>
        <p>
...
<details>
    <summary>
        ...
        <ul>
            ...
            <br>
            <li>Configurable via Minecraft's debug entries screen (F3 + F4, search <code>"quality of queso")</code></li>
        </ul>
        <p>
...
<details>
    <summary>
        ...
        <ul>
            ...
            <br>
            <li>Found in the mod's <code>main menu</code></li>
        </ul>
</details>
...
# FAQ
### *Q:* Does this mod work with mods like *sophisticated backpacks, iron chests,* etc?
### *A:* Not right now.
