...
public class InventorySortingOptionsScreen extends AbstractModOptionsScreen {

    public InventorySortingOptionsScreen(Screen parent) {
        super(parent, Text.translatable("qualityofqueso.gui.inventory_sorting_options"));
    }
