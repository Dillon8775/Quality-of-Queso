...
public class ModListOptions {
    ...
    public static final SimpleOption<Boolean> INVENTORY_SEARCHING = new SimpleOption<>("qualityofqueso.options.inventory_sorting", SimpleOption.constantTooltip(Text.translatable("qualityofqueso.options.inventory_sorting.tooltip")),
