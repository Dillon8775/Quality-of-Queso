...
public enum ContainerSorting implements StringIdentifiable {
    ...
    public static final Codec<ContainerSorting> Codec = StringIdentifiable.createCodec(ContainerSorting::values);
