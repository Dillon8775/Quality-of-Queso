...
public enum Transferring implements StringIdentifiable {
    ...
    public static final Codec<Transferring> Codec = StringIdentifiable.createCodec(Transferring::values);
    private final int ordinal;
    private final String name;
    private final Text translationKey;

    Transferring(final int ordinal, final String name, final String translationKey) {
